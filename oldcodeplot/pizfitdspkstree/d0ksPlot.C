...

{
  ...
  RooPlot* frame1 = d0mass.frame(Bins(nBins),Title("D^{0} Mass From MC Data")); //Edit the Title of the plot here
  frame1->addTH1(hd);
  //frame1->addTH1(hd3);
  ...
  canvas->Print("/home/taylor/Research/plots/pizfitdspkstree/d0ks.pdf","pdf"); 
  canvas->Print("/home/taylor/Research/plots/pizfitdspkstree/d0ks.eps","eps");
