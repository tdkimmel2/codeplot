...

{
  ...
  RooPlot* frame1 = coskspiz.frame(Bins(nBins),Title("cos(#theta_{K^{0}_{S}#pi^{0}}) From MC Data")); //Edit the Title of the plot here
  frame1->addTH1(hd);
  //frame1->addTH1(hd3);
  ...
  canvas->Print("/home/taylor/Research/plots/pizfitdspkstree/coskspiz.pdf","pdf"); 
  canvas->Print("/home/taylor/Research/plots/pizfitdspkstree/coskspiz.eps","eps");
