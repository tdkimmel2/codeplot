...

{
  ...
  */
  ...
  RooPlot* frame1 = pimass.frame(Bins(nBins),Title("#pi^{+} Mass From MC Data")); //Edit the Title of the plot here
  frame1->addTH1(hd);
  //frame1->addTH1(hd3);
  ...
  canvas->Print("./pimass.pdf","pdf"); 
  canvas->Print("./pimass.eps","eps");
