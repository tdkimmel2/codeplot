...

{
  ...
  RooPlot* frame1 = deltam.frame(Bins(nBins),Title("#Delta M_{D^{*+},D^{0}} From MC Data")); //Edit the Title of the plot here
  frame1->addTH1(hd);
  frame1->addTH1(hd3);
  ...
  canvas->Print("./deltam.pdf","pdf"); 
  canvas->Print("./deltam.eps","eps");
