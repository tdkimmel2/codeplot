...

{
  ...
  // Fit observables                                                                           
  RooRealVar deltam2("deltam2", "deltam2", 0.5, 0.7);
...
//"d0mass < 1.994 && d0mass > 1.706"
  ...
  RooRealVar sigwidth1("#sigma_{signal1}", "#sigma_{signal}", 0.04, 0.0, 0.5);
  ...
  c->Print("/home/taylor/Research/plots/dspkstree/roofit/gausschebydeltam2ksfit.pdf","pdf");
  c->Print("/home/taylor/Research/plots/dspkstree/roofit/gausschebydeltam2ksfit.eps","eps");
  c->Print("/home/taylor/Research/plots/dspkstree/roofit/gausschebydeltam2ksfit.png","png");
