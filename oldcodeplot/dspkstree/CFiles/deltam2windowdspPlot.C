...

{
  ...
  hd->SetLineWidth(2);
  t1->Draw("dspmass>>hd", "deltam2 > 0.5561 && deltam2 < 0.5709"); //5 sigmas window around d0 mass
  ...
  canvas->Print("/home/taylor/Research/plots/dsptree/deltam2windowdsp.pdf","pdf"); 
  canvas->Print("/home/taylor/Research/plots/dsptree/deltam2windowdsp.eps","eps");
