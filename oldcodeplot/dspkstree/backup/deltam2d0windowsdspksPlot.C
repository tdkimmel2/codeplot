...

{
  ...
  canvas->Print("/home/taylor/Research/plots/dspkstree/deltam2d0windowsdspkstruth.pdf","pdf"); 
  canvas->Print("/home/taylor/Research/plots/dspkstree/deltam2d0windowsdspkstruth.eps","eps");
