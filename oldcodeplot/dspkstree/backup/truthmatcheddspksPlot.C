...

{
  ...
  canvas->Print("/home/taylor/Research/plots/dspkstree/truthmatcheddspks.pdf","pdf"); 
  canvas->Print("/home/taylor/Research/plots/dspkstree/truthmatcheddspks.eps","eps");
