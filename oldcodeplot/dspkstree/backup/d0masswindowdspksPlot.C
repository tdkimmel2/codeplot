...

{
  ...
  canvas->Print("/home/taylor/Research/plots/dspkstree/d0masswindowdspks.pdf","pdf"); 
  canvas->Print("/home/taylor/Research/plots/dspkstree/d0masswindowdspks.eps","eps");
