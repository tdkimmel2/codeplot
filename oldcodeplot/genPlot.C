...

{
  ...
  int nBins = 100; 
  TFile *f1=new TFile("/home/tkimmel/belle/chargeddrecon/dptest.root"); //put file here
  TTree *t1=(TTree*) f1->Get("dpstree"); //put tree name here
  ...
  RooPlot* frame1 = dpsmass.frame(Bins(nBins),Title("D*^{+} Mass")); //Edit the Title of the plot here
  frame1->addTH1(hd);
  frame1->addTH1(hd3);
  ...
  canvas->Print("./dpstest.pdf","pdf"); 
  canvas->Print("./dpstest.eps","eps");
