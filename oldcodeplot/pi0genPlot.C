...

{
  ...
  TTree *t1=(TTree*) f1->Get("pi0tree"); //put tree name here
  ...
  RooPlot* frame1 = pi0mass.frame(Bins(nBins),Title("#pi^{0} Mass Fit with E_{#gamma}<60 MeV and Mass Range Cuts: From MC Data")); //Edit the Title of the plot here
  frame1->addTH1(hd);
  //frame1->addTH1(hd3);
  ...
  canvas->Print("./pi0mass.pdf","pdf"); 
  canvas->Print("./pi0mass.eps","eps");
