...
f1 = "/home/taylor/Research/root/nbpi0/nomfreconnb.root"
tree = "pi0tree"
f = TFile(f1,"READ")
t = f.Get(tree)
...
bkg = RooChebychev("poly","Chebychev Bkg Fcn",pi0mass,RooArgList(c0))
...
canvas.Print("/home/taylor/Research/plots/nbpi0/nbpi0mass_gaussian+cheby_fit.pdf")
canvas.Print("/home/taylor/Research/plots/nbpi0/nbpi0mass_gaussian+cheby_fit.eps")
canvas.Print("/home/taylor/Research/plots/nbpi0/nbpi0mass_gaussian+cheby_fit.png")
