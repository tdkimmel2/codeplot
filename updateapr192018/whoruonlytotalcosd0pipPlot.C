...
void whoruonlytotalcosd0pipPlot()

{
  ...
  leg1->AddEntry(frame1->findObject("hd2"),"Very Loose Truth Matched","l");
  ...
  canvas->Print("./whoruonlytotalcosd0pip.pdf","pdf"); 
  canvas->Print("./whoruonlytotalcosd0pip.eps","eps");
