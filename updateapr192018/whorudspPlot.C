...

{
  ...
  RooPlot* frame1 = dspmass.frame(Bins(nBins),Title("Truth Matched D*^{+} Mass From MC Data")); //Edit the Title of the plot here
  frame1->addTH1(hd);
  frame1->addTH1(hd3);
  ...
  canvas->Print("./whorudsprecon.pdf","pdf"); 
  canvas->Print("./whorudsprecon.eps","eps");
