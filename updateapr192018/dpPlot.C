...

{
  ...
  int nBins = 100; 
  TFile *f1=new TFile("/home/taylor/Research/root/dptest.root"); //put file here
  TTree *t1=(TTree*) f1->Get("dptree"); //put tree name here
  ...
  RooPlot* frame1 = dpmass.frame(Bins(nBins),Title("D^{+} Mass")); //Edit the Title of the plot here
  frame1->addTH1(hd);
  frame1->addTH1(hd3);
