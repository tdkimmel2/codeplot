...

{
  ...
  chain_data->Add("/home/taylor/Research/root/dsprecond0fit.root");                                                      
...
//"d0mass < 1.994 && d0mass > 1.706"
  ...
  RooRealVar sigwidth1("#sigma_{signal1}", "#sigma_{signal}", 0.04, 0.0, 0.1);
  ...
  RooAddPdf pdf("pdf", "pdf", RooArgList(gauss, poly), RooArgList(frac));
  ...
  c->Print("/home/taylor/Research/plots/d0fitdspkstree/roofit/gausschebydeltam2ksfit.pdf","pdf");
  c->Print("/home/taylor/Research/plots/d0fitdspkstree/roofit/gausschebydeltam2ksfit.eps","eps");
