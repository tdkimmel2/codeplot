...

{
  ...
  canvas->Print("/home/taylor/Research/plots/d0fitdspkstree/deltam2ks.pdf","pdf"); 
  canvas->Print("/home/taylor/Research/plots/d0fitdspkstree/deltam2ks.eps","eps");
