...

{
  ...
  hd->SetLineWidth(2);
  t1->Draw("dspmass>>hd", "deltam2 > 0.538649 && deltam2 < 0.588349"); //5 sigmas window around deltam2 mass
  ...
  canvas->Print("/home/taylor/Research/plots/d0fitdspkstree/deltam2windowdsp.pdf","pdf"); 
  canvas->Print("/home/taylor/Research/plots/d0fitdspkstree/deltam2windowdsp.eps","eps");
