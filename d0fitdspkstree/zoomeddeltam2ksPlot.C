...

{
  ...
  RooRealVar deltam2("deltam2", "deltam2", 0.46, 0.66);
  ...
  RooPlot* frame1 = deltam2.frame(Bins(nBins),Title("#DeltaM^{2} From MC Data")); //Edit the Title of the plot here
  frame1->addTH1(hd);
  //frame1->addTH1(hd3);
  ...
  canvas->Print("/home/taylor/Research/plots/d0fitdspkstree/zoomeddeltam2ks.pdf","pdf"); 
  canvas->Print("/home/taylor/Research/plots/d0fitdspkstree/zoomeddeltam2ks.eps","eps");
