...

{
  ...
  leg1->AddEntry(frame1->findObject("hd2"),"cos(#theta_{K_{S}#pi^{0}}) > 0.5","l");
  ...
  leg1->AddEntry(frame1->findObject("hd3"),"cos(#theta_{K_{S}#pi^{0}}) < 0.5","l");
