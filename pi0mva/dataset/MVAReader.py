...
f = TFile("/home/taylor/Research/codeplot/tmvapi0/MVAOutput.root","READ")
...
t.Draw("BDT>>hSig3(22,-0,1)","classID == 0","goff")  # signal
t.Draw("BDT>>hBg3(22,-0,1)","classID == 1", "goff")  # background
...
ROOT.hSig3.SetLineColor(ROOT.kGreen); ROOT.hSig3.SetLineWidth(2)  # signal histogram
ROOT.hBg3.SetLineColor(ROOT.kPink); ROOT.hBg3.SetLineWidth(2)   # background histogram
