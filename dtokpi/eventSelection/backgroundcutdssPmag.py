...
NoBackgroundCut_GreaterThan(rb,lb,t,"dsPmag","mcflag","abs(dsflag)==1 && deltam > 0.1423971 && deltam < 0.1489743","From All Generic MC: Reconstructed D* 3-Momentum Magnitude D* -> D^{0}(-> #pi^{0} + K_{S}^{0}) + #pi","|p_{D*}| (GeV/c)",h1,h2,frame,0.6,"/home/tkimmel/Research/plots/alldtokpi/ksRecon_noBackgroundCut_deltamWindow2ndPass_99Purity",0.99)
