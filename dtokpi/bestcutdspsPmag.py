...
OptimizeCut_GreaterThan(rb,lb,t,"dspPmag","mcflag","whomi>3","From All MC: Reconstructed D^{*+} 3-Momentum Magnitude D^{*+} -> D^{0}(-> #pi^{0} + K_{S}^{0}) + #pi^{+}","|p_{D^{*+}}| (GeV/c)",h1,h2,frame,frame2,0.7,"/home/tkimmel/Research/plots/genericdtokpi/bestdspsPmagcut","std")
