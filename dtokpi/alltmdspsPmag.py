...
plot_variable4histos(rb,lb,t,"dspPmag","mcflag==2 && whomi > 3","Charm MC","mcflag==3 && whomi > 3","Mixed MC","mcflag==4 && whomi > 3","Charged MC","mcflag==5 && whomi > 3","UDS MC","Truth-Matched Reconstructed D^{*+} 3-Momentum Magnitude D^{*+} -> D^{0}(-> #pi^{0} + K_{S}^{0}) + #pi^{+}: From All MC","|p_{D^{*+}}| (GeV/c)",h1,h2,h3,h4,frame,0.65,0.6,"/home/tkimmel/Research/plots/alldtokpi/alltmdspsPmag")
#plot_variable4histos(rb,lb,t,"dspPmag","mcflag==2 && whomi > 3","Charm MC","mcflag==3 && whomi > 3","Mixed MC","mcflag==4 && whomi > 3","Charged MC","mcflag==5 && whomi > 3","UDS MC","Reconstructed D^{*+} 3-Momentum Magnitude D^{*+} -> D^{0}(-> #pi^{0} + K_{S}^{0}) + #pi^{+}: From All MC","|p_{D^{*+}}| (GeV/c)",h1,h2,h3,h4,frame,0.65,0.6,"/home/taylor/Research/plots/alldtokpi/alltmdspsPmag")
