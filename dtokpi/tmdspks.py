...
#plot_variable2histos(rb,lb,t,"deltam","whomi>3","Truth Matched No Cuts: ","","No Cuts: ","Truth Matched #DeltaM_{D^{*+}D^{0}} D^{*+} -> D^{0}(-> #pi^{0} + K_{S}^{0}) + #pi^{+}: From All MC","#DeltaM_{D^{*+}D^{0}} (GeV/c^{2})",h1,h2,frame,0.45,0.3,"/home/tkimmel/Research/plots/alldtokpi/nocuttmks")
#plot_variable2histos(rb,lb,t,"deltam","whomi>3 && pipp<0.38","Truth Matched |#vec{p}_{#pi^{+}}| < 0.38: ","pipp<0.38","|#vec{p}_{#pi^{+}}| < 0.38: ","Truth Matched #DeltaM_{D^{*+}D^{0}} D^{*+} -> D^{0}(-> #pi^{0} + K_{S}^{0}) + #pi^{+}: From All MC","#DeltaM_{D^{*+}D^{0}} (GeV/c^{2})",h1,h2,frame,0.45,0.3,"/home/tkimmel/Research/plots/alldtokpi/pippcuttmks")
#plot_variable2histos(rb,lb,t,"deltam","whomi>3 && coskpiz>0.24","Truth Matched cos(#theta_{K^{0}#pi^{0}}) > 0.24: ","coskpiz>0.24","cos(#theta_{K^{0}#pi^{0}}) > 0.24: ","Truth Matched #DeltaM_{D^{*+}D^{0}} D^{*+} -> D^{0}(-> #pi^{0} + K_{S}^{0}) + #pi^{+}: From All MC","#DeltaM_{D^{*+}D^{0}} (GeV/c^{2})",h1,h2,frame,0.45,0.65,"/home/tkimmel/Research/plots/alldtokpi/coskpizcuttmks")
#plot_variable2histos(rb,lb,t,"deltam","whomi>3 && cosdpipcm>0.985","Truth Matched cos(#theta_{D^{0}#pi^{+}}) > 0.985: ","cosdpipcm>0.985","cos(#theta_{D^{0}#pi^{+}}) > 0.985: ","Truth Matched #DeltaM_{D^{*+}D^{0}} D^{*+} -> D^{0}(-> #pi^{0} + K_{S}^{0}) + #pi^{+}: From All MC","#DeltaM_{D^{*+}D^{0}} (GeV/c^{2})",h1,h2,frame,0.45,0.65,"/home/tkimmel/Research/plots/alldtokpi/cosdpipcuttmks")
#plot_variable2histos(rb,lb,t,"deltam","whomi>3 && dspPmag>3.2","Truth Matched |#vec{p}_{#D^{*+}}| > 3.2: ","dspPmag>3.2","|#vec{p}_{#D^{*+}}| > 3.2: ","Truth Matched #DeltaM_{D^{*+}D^{0}} D^{*+} -> D^{0}(-> #pi^{0} + K_{S}^{0}) + #pi^{+}: From All MC","#DeltaM_{D^{*+}D^{0}} (GeV/c^{2})",h1,h2,frame,0.45,0.3,"/home/tkimmel/Research/plots/alldtokpi/dspPmagcuttmks")
