...
#plot_variable(t,"deltam","chrgflag==1","#DeltaM_{D^{*+}D^{0}} D^{*+} -> D^{0}(-> #pi^{0} + K_{L}^{0}) + #pi^{+}: From K^{0} Signal MC","#DeltaM_{D^{*+}D^{0}} (GeV/c^{2})",h1,frame,0.65,0.65,"/home/tkimmel/Research/plots/k0SignalMC/klRecon_dsp")
#plot_variable(t,"deltam","chrgflag==-1","#DeltaM_{D^{*-}D^{0}} D^{*-} -> D^{0}(-> #pi^{0} + K_{L}^{0}) + #pi^{-}: From K^{0} Signal MC","#DeltaM_{D^{*-}D^{0}} (GeV/c^{2})",h1,frame,0.65,0.65,"/home/tkimmel/Research/plots/k0SignalMC/klRecon_dsm")
plot_variable(t,"deltam","","#DeltaM_{D^{*}D^{0}} D^{*} -> D^{0}(-> #pi^{0} + K_{L}^{0}) + #pi: From K^{0} Signal MC","#DeltaM_{D^{*}D^{0}} (GeV/c^{2})",h1,frame,0.65,0.65,"/home/tkimmel/Research/plots/k0SignalMC/klRecon_ds")
