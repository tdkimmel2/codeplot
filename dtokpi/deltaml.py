...
plot_variable2histos(t,"deltam","abs(dsflag)==1","Truth Matched","","Total","#DeltaM_{D*D^{0}} D* -> D^{0}(-> #pi^{0} + K_{L}^{0}) + #pi: From All Generic MC","#DeltaM_{D*D^{0}} (GeV/c^{2})",h1,h2,frame,0.65,0.65,"/home/tkimmel/Research/plots/klSignalMC/klRecon_TM")
