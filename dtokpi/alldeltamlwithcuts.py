...
plot_variable4histos(rb,lb,t,"deltam","mcflag==2 && coskpiz>0.24 && cosdpipcm>0.985 && pipp<0.38","Charm MC","mcflag==3 && coskpiz>0.24 && cosdpipcm>0.985 && pipp<0.38","Mixed MC","mcflag==4 && coskpiz>0.24 && cosdpipcm>0.985 && pipp<0.38","Charged MC","mcflag==5 && coskpiz>0.24 && cosdpipcm>0.985 && pipp<0.38","UDS MC","#DeltaM_{D^{*+}D^{0}} D^{*+} -> D^{0}(-> #pi^{0} + K_{L}^{0}) + #pi^{+}: From All MC and All Cuts Applied","#DeltaM_{D^{*+}D^{0}} (GeV/c^{2})",h1,h2,h3,h4,frame,0.65,0.65,"/home/tkimmel/Research/plots/alldtokpi/alldeltamlwithcuts")
#plot_variable4histos(rb,lb,t,"deltam","mcflag==2 && coskpiz>0.24 && cosdpipcm>0.985 && pipp<0.38","Charm MC","mcflag==3 && coskpiz>0.24 && cosdpipcm>0.985 && pipp<0.38","Mixed MC","mcflag==4 && coskpiz>0.24 && cosdpipcm>0.985 && pipp<0.38","Charged MC","mcflag==5 && coskpiz>0.24 && cosdpipcm>0.985 && pipp<0.38","UDS MC","#DeltaM_{D^{*+}D^{0}} D^{*+} -> D^{0}(-> #pi^{0} + K_{L}^{0}) + #pi^{+}: From All MC and All Cuts Applied","#DeltaM_{D^{*+}D^{0}} (GeV/c^{2})",h1,h2,h3,h4,frame,0.65,0.65,"/home/taylor/Research/plots/alldtokpi/alldeltamlwithcuts")
