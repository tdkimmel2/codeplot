...
plot_variable5histos(rb,lb,t,"deltam","mcflag==1 && whomi > 3","Inclusive MC","mcflag==2 && whomi > 3","Charm MC","mcflag==3 && whomi > 3","Mixed MC","mcflag==4 && whomi > 3","Charged MC","mcflag==5 && whomi > 3","UDS MC","#DeltaM_{D^{*+}D^{0}} D^{*+} -> D^{0}(-> #pi^{0} + K_{L}^{0}) + #pi^{+}: From All MC","#DeltaM_{D^{*+}D^{0}} (GeV/c^{2})",h1,h2,h3,h4,h5,frame,0.65,0.6,"/home/tkimmel/Research/plots/alldtokpi/alltmdeltaml")
#plot_variable5histos(rb,lb,t,"deltam","mcflag==1 && whomi > 3","Inclusive MC","mcflag==2 && whomi > 3","Charm MC","mcflag==3 && whomi > 3","Mixed MC","mcflag==4 && whomi > 3","Charged MC","mcflag==5 && whomi > 3","UDS MC","#DeltaM_{D^{*+}D^{0}} D^{*+} -> D^{0}(-> #pi^{0} + K_{L}^{0}) + #pi^{+}: From All MC","#DeltaM_{D^{*+}D^{0}} (GeV/c^{2})",h1,h2,h3,h4,h5,frame,0.65,0.6,"/home/taylor/Research/plots/alldtokpi/alltmdeltaml")
