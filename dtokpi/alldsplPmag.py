...
#plot_variable5histos(rb,lb,t,"dspPmag","mcflag==1","Inclusive MC","mcflag==2","Charm MC","mcflag==3","Mixed MC","mcflag==4","Charged MC","mcflag==5","UDS MC","Reconstructed D^{*+} 3-Momentum Magnitude D^{*+} -> D^{0}(-> #pi^{0} + K_{L}^{0}) + #pi^{+}: From All MC","|p_{D^{*+}}| (GeV/c)",h1,h2,h3,h4,h5,frame,0.65,0.6,"/home/taylor/Research/plots/alldtokpi/alldsplPmag")
