...
OptimizeCut_GreaterThan(rb,lb,t,"nn","truth","","From MC: D^{*+} NeuroBayes Output D^{*+} -> D^{0}(-> #pi^{0} + K^{0}) + #pi^{+}","nn",h1,h2,frame,frame2,0.7,"/home/taylor/Research/plots/bestcutdnbexpert2variables","std")
